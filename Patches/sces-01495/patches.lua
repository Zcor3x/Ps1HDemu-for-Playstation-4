-- Lua 5.3
-- Title:   Medievil - SCES-01495 (EU-ES)
...
--	emu.Log(string.format("gulButtonHelpMask = %d", gulButtonHelpMask))
	...
	cpu.WriteMem32(0x800EF6B0, 0x800EDA50)
end
...
function install_title_hooks()
	...
	hooks[4] = cpu.AddHook(0x8004EA78, 0xAF800588, xGameFadeUpdate)
	showingConfirmation = false
	needsReinit = false
end
...
function boot() -- _start
	...
	cpu.WriteMemStrZ(0x800C6614, "BESCES-00311")
end
